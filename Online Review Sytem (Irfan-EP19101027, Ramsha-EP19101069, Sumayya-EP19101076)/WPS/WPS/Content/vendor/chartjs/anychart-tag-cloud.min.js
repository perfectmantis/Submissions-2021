 ...
 */
(function (global, factory) { if (typeof module === 'object' && typeof module.exports === 'object') { var wrapper = function (w) { if (!w.document) { throw Error('AnyChart requires a window with a document'); } factory.call(w, w, w.document); try { w.acgraph.isNodeJS = Object.prototype.toString.call(global.process) == "[object process]"; } catch (e) { }; return w.anychart; }; module.exports = global.document ? wrapper(global) : wrapper; } else { factory.call(global, window, document) } })(typeof window !== 'undefined' ? window : this, function (window, document, opt_noGlobal) {
    var $, _, $_ = this.anychart; if ($_ && (_ = $_._)) { $ = $_.$ } else { throw Error('anychart-base.min.js module should be included first. See modules explanation at https://docs.anychart.com/Quick_Start/Modules for details'); $ = {}; _ = {} } if (!_.color_scales) {
        _.color_scales = 1; (function ($) {
            var xM, AM, BM, CM, FM; $.uM = function (a, b) { var c = a.i("fontSize") != b; null === b ? delete a.yd.fontSize : a.yd.fontSize = b; c && a.u(4) }; $.vM = function (a) { var b = {}; $.Bc(a.La, function (a, d) { if ($.n(a)) { if ("adjustByHeight" == d || "adjustByWidth" == d) d = "adjustFontSize"; b[d] = this.ed(d) } }, a); return b }; $.wM = function (a, b) { return $.pk(Bea, a, b || "clip") }; xM = function () { $.cy.call(this) };
            ...
            $.DM = function (a, b) {
                if (a.b) {
                    var c = a.scale(), d = $.Yq(a, "marker"), e = a.b, f = e.td() || (e.hn ? e.hn() : void 0), h = d && d.enabled(); e = e.enabled() && f == c; if (a.enabled() && h && c && e && (c = a.line.lb(), h = $.Za(a.scale().transform(b, .5), 0, 1), !(0, window.isNaN)(h))) {
                        e = a.i("orientation"); f = d.i("size"); switch (e) {
                            case "top": var k = c.left + c.width * h; var l = c.top + c.height + f; var m = 180; break; case "bottom": k = c.left + c.width * h; l = c.top - f; m = 0; break; case "left": k = c.left + c.width + f; l = c.top + c.height - c.height * h; m = 90; break; case "right": k = c.left - f,
                            l = c.top + c.height - c.height * h, m = -90
                        } $.V(d); d.pa("rotation", m); d.Ec({ value: { x: k, y: l } }); d.da(!1); d.Y(); d.Hd().visible(!0)
                    }
                }
            }; $.EM = function (a) { var b = $.Yq(a, "marker"); a.scale() && b && b.Hd().visible(!1) }; FM = function () { $.yM.call(this) }; $.Nw.prototype.hn = $.ca(22, function () { return this.Lb }); var Bea = { Wja: "always-show", Qka: "clip", wla: "drop" }; $.H(xM, $.cy);
            ...
            $.g.Op = function (a, b) {
                var c = this.scale(), d = {}; if ($.K(c, $.ry)) { var e = (0, window.parseFloat)(b); var f = c.DD(e); var h = "number" } else if ($.K(c, $.uy)) { e = b; f = c.Sa().names()[a]; h = "string"; var k = c.kn(b); k && (d.colorRange = { value: { color: k.color, end: k.end, name: k.name, start: k.start, index: k.sourceIndex }, type: "" }) } d.index = { value: a, type: "number" }; d.value = { value: f, type: h }; d.tickValue = { value: e, type: "number" }; d.max = { value: $.n(c.max) ? c.max : null, type: "number" }; d.min = { value: $.n(c.min) ? c.min : null, type: "number" }; d.scale = {
                    value: c,
                    type: ""
                }; return $.Bu(new $.Rv(d))
            };
            $.g.fP = function (a, b, c, d, e) {
                c = a.top + a.height + c / 2 - d; var f = this.scale(); if ($.K(f, $.ry)) this.line.moveTo(a.left + b, c).lineTo(a.left - b + a.width, c).lineTo(a.left - b + a.width, c - e).lineTo(a.left + b, c - e).close(); else if ($.K(f, $.uy)) {
                    d = f.Rq(); f = f.Oj(); for (var h = a.width / (d.length - 1), k = 0, l = d.length - 1; k < l; k++) {
                        var m = d[k]; m = m.color || f[m.sourceIndex] || f[f.length - 1]; var p = this.lines[k] ? this.lines[k].clear() : this.lines[k] = this.line.path(), q = a.left + b + h * k; p.moveTo(q, c).lineTo(q + h, c).lineTo(q + h, c - e).lineTo(q, c - e).close();
                        p.stroke(this.i("stroke")); p.fill(m)
                    }
                }
            };
            $.g.yE = function (a, b, c, d, e) {
                c = a.left - c / 2 + d; var f = this.scale(); if ($.K(f, $.ry)) this.line.moveTo(c, a.top + b).lineTo(c, a.top - b + a.height).lineTo(c + e, a.top - b + a.height).lineTo(c + e, a.top + b).close(); else if ($.K(f, $.uy)) {
                    d = f.Rq(); f = f.Oj(); for (var h = a.height / (d.length - 1), k = 0, l = d.length - 1; k < l; k++) {
                        var m = d[k]; m = m.color || f[m.sourceIndex] || f[f.length - 1]; var p = this.lines[k] ? this.lines[k].clear() : this.lines[k] = this.line.path(), q = a.top + b + h * (d.length - 1 - k - 1); p.moveTo(c, q).lineTo(c, q + h).lineTo(c + e, q + h).lineTo(c + e, q).close();
                        p.stroke(this.i("stroke")); p.fill(m)
                    }
                }
            };
            $.g.wE = function (a, b, c, d, e) {
                c = a.top - c / 2 + d; var f = this.scale(); if ($.K(f, $.ry)) this.line.moveTo(a.left + b, c).lineTo(a.left - b + a.width, c).lineTo(a.left - b + a.width, c + e).lineTo(a.left + b, c + e).close(); else if ($.K(f, $.uy)) {
                    d = f.Rq(); f = f.Oj(); for (var h = a.width / (d.length - 1), k = 0, l = d.length - 1; k < l; k++) {
                        var m = d[k]; m = m.color || f[m.sourceIndex] || f[f.length - 1]; var p = this.lines[k] ? this.lines[k].clear() : this.lines[k] = this.line.path(), q = a.left + b + h * k; p.moveTo(q, c).lineTo(q + h, c).lineTo(q + h, c + e).lineTo(q, c + e).close(); p.stroke(this.i("stroke"));
                        p.fill(m)
                    }
                }
            };
            $.g.xE = function (a, b, c, d, e) {
                c = a.left + a.width + c / 2 - d; var f = this.scale(); if ($.K(f, $.ry)) this.line.moveTo(c, a.top + b).lineTo(c, a.top - b + a.height).lineTo(c - e, a.top - b + a.height).lineTo(c - e, a.top + b).close(); else if ($.K(f, $.uy)) {
                    d = f.Rq(); f = f.Oj(); for (var h = a.height / (d.length - 1), k = 0, l = d.length - 1; k < l; k++) {
                        var m = d[k]; m = m.color || f[m.sourceIndex] || f[f.length - 1]; var p = this.lines[k] ? this.lines[k].clear() : this.lines[k] = this.line.path(), q = a.top + b + h * (d.length - 1 - k - 1); p.moveTo(c, q).lineTo(c, q + h).lineTo(c - e, q + h).lineTo(c -
            ...
            $.g.Bv = function (a) {
                if (this.b) {
                    var b = this.scale(), c = this.b, d = c && (c.td() || (c.hn ? c.hn() : void 0)); if (this.enabled() && b && c.enabled() && d == b) {
                        d = this.line.lb(); if (this.Hb()) { var e = a.clientX; var f = d.left + $.Nj(this.P().Ha()).x; d = (e - f) / d.width } else e = a.clientY, f = d.top + $.Nj(this.P().Ha()).y, d = (d.height - (e - f)) / d.height; d = b.Pc(d); a.metaKey || a.shiftKey || !c.map || c.map.Yd(); if ($.K(b, $.uy)) d = b.kn(d), b && c && (e = this.N[d.sourceIndex], b = c.mc(), b = b.Wc(), "single" == b.i("hoverMode") ? this.Hf = { W: c, pd: e } : this.Hf = [{
                            W: c, pd: e, tn: e[e.length -
                            1], ue: { index: e[e.length - 1], $f: 0 }
                        }]); else if ($.K(b, $.ry)) { a = c.xc(); e = window.Infinity; for (var h = window.NaN, k = b.th(), l = b.Mh() ; a.advance() ;) { f = a.get(c.Qe ? c.Qe.kl : c.ir[1]); f = $.Za(f, k, l); var m = Math.abs(d - f); e > m && (e = m, h = f) } e = []; a = c.xc(); for (d = h; a.advance() ;) f = a.get(c.Qe ? c.Qe.kl : c.ir[1]), f = $.Za(f, k, l), f == d && e.push(a.la()); b && c && (b = c.mc(), b = b.Wc(), "single" == b.i("hoverMode") ? this.Hf = { W: c, pd: e } : this.Hf = [{ W: c, pd: e, tn: e[e.length - 1], ue: { index: e[e.length - 1], $f: 0 } }]) }
                    }
                }
            };
            $.g.ng = function (a) {
                if (this.b) {
                    var b = this.scale(), c = this.b, d = c.td() || (c.hn ? c.hn() : void 0); if (this.enabled() && b && c.enabled() && d == b) {
                        d = this.line.lb(); if (this.Hb()) { var e = a.clientX; var f = d.left + $.Nj(this.P().Ha()).x; d = (e - f) / d.width } else e = a.clientY, f = d.top + $.Nj(this.P().Ha()).y, d = (d.height - (e - f)) / d.height; d = b.Pc(d); if ($.K(b, $.uy)) { a = b.kn(d); var h = this.N[a.sourceIndex]; b = c.mc(); f = b.Wc(); "single" == f.i("hoverMode") ? this.Hf = { W: c, pd: h } : this.Hf = [{ W: c, pd: h, tn: h[h.length - 1], ue: { index: h[h.length - 1], $f: 0 } }] } else if ($.K(b,
                        $.ry) && c) {
                            f = c.xc(); h = window.Infinity; for (var k = window.NaN, l = b.th(), m = b.Mh() ; f.advance() ;) { e = f.get(c.Qe ? c.Qe.kl : c.ir[1]); e = $.Za(e, l, m); var p = Math.abs(d - e); h > p && (h = p, k = e) } h = []; f = c.xc(); for (d = k; f.advance() ;) e = f.get(c.Qe ? c.Qe.kl : c.ir[1]), e = $.Za(e, l, m), e == d && h.push(f.la()); b && c && (b = c.mc(), f = b.Wc(), "single" == f.i("hoverMode") ? (this.Hf && !(0, $.rC)(h, function (a) { return $.Aa(this.Hf.pd, a) }, this) && b.dispatchEvent(b.Bk("hovered", a, [{ W: c, pd: [], ue: { index: this.Hf.pd[this.Hf.pd.length - 1], $f: 0 } }], !1)), this.Hf = {
                                W: c,
                                pd: h
                            }) : this.Hf = [{ W: c, pd: h, tn: h[h.length - 1], ue: { index: h[h.length - 1], $f: 0 } }])
                        } $.DM(this, d)
                    }
                }
            }; $.g.Cg = function () { $.EM(this); var a = this.b; a && (this.Pa = a) }; $.g.remove = function () { var a = $.Yq(this, "marker"); a && a.remove(); $.yM.B.remove.call(this) }; $.g.F = function () { var a = $.yM.B.F.call(this); $.uq(this, GM, a); a.marker = this.ar().F(); return a }; $.g.X = function (a, b) { $.yM.B.X.call(this, a, b); $.mq(this, GM, a, b); this.ar(a.marker) }; $.g.R = function () { $.od(this.Il, this.g); this.g = this.Il = null; $.yM.B.R.call(this) }; $.H(FM, $.yM);
            $.Kt(FM, $.yM); var HM = $.yM.prototype; HM.marker = HM.ar; HM = FM.prototype; $.F("anychart.standalones.colorRange", function () { var a = new FM; a.Fa("standalones.colorRange"); return a }); HM.padding = HM.padding; HM.draw = HM.Y; HM.parentBounds = HM.ja; HM.container = HM.P;
        }).call(this, $)
    }
    if (!_.theme_color_scales) {
        _.theme_color_scales = 1; (function ($) {
            $.ra($.fa.anychart.themes.defaultTheme, {
                defaultColorRange: {
                    enabled: !1, stroke: "#B9B9B9", orientation: "bottom", title: { enabled: !1 }, colorLineSize: 10, padding: { top: 10, right: 0, bottom: 0, left: 0 }, margin: 0, align: "center", length: "50%", marker: { padding: 3, positionFormatter: $.ZL, enabled: !0, disablePointerEvents: !1, position: "center", rotation: 0, anchor: "center", offsetX: 0, offsetY: 0, type: "triangle-down", fill: "#333 0.85", stroke: "none", size: 7 }, labels: { offsetX: 0, offsetY: 0, fontSize: 11, padding: 0 }, ticks: {
                        stroke: "#B9B9B9", position: "outside",
                        length: 5, enabled: !0
                    }, minorTicks: { stroke: "#B9B9B9", position: "outside", length: 3, enabled: !1 }
                }, defaultOrdinalColorScale: { inverted: !1, ticks: { maxCount: 100 }, autoColors: function (a) { return $.Bl("#90caf9", "#01579b", a) } }, defaultLinearColorScale: { maxTicksCount: 1E3, colors: ["#90caf9", "#01579b"], minimumGap: 0, maximumGap: 0 }
            }); $.ra($.fa.anychart.themes.defaultTheme.standalones, { colorRange: { enabled: !0, zIndex: 50 } });
        }).call(this, $)
    }
    if (!_.tag_cloud_part) {
        _.tag_cloud_part = 1; (function ($) {
            var cna = function (a) { var b = new $.sh; b.parent(a); return b }, dna = function (a, b) { a.Jn = b; a.Jn.push("#000"); a.ZT = !!b; a.reset() }, Z7 = function (a, b) {
                $.Rw.call(this); this.Fa("tagCloud"); this.ir = ["x", "value"]; this.ga = "category"; this.Ja = this.O = window.NaN; var c = [$.Z.H5], d = {}; $.T(d, [["fill", 16, 1], ["fontFamily", 16388, 1], ["fontStyle", 16388, 1], ["fontVariant", 16388, 1], ["fontWeight", 16388, 1], ["fontSize", 16388, 1]]); var e = {}; $.T(e, [["fill", 0, 0], ["fontFamily", 0, 0], ["fontStyle", 0, 0], ["fontVariant", 0, 0], ["fontWeight", 0, 0],
                ["fontSize", 0, 0]]); this.ba = new $.zx(this, d, $.Vl, c); this.wa = new $.zx(this, e, $.fo, c); this.Ca = new $.zx(this, e, $.go, c); this.ba.Fa(this.ma); $.W(this, "normal", this.ba); $.W(this, "hovered", this.wa); $.W(this, "selected", this.Ca); this.state = new $.uw(this); this.data(a || null, b); $.T(this.ua, [["mode", 4, 1], ["fromAngle", 8192, 1], ["toAngle", 8192, 1], ["anglesCount", 8192, 1], ["textSpacing", 4, 1]]); this.Va()
            }, $7 = function (a, b) { $.z(b) ? (a.be("fill", b), a.be("fill-opacity", 1)) : (a.be("fill", b.color), a.be("fill-opacity", b.opacity)) },
            a8 = function (a, b, c) {
                if (c != $.Vl) { var d = c == $.fo ? a.wa : a.Ca; d = d.i(b); var e = $.eo(d); if (null != d && !$.E(d) && !e) return d } var f = a.aa().o("item"); c = a.ba.i(b); var h = $.eo(c); if (null == c || h) { switch (b) { case "fontFamily": var k = f.font; break; case "fill": k = f.fill; break; case "fontStyle": k = f.style; break; case "fontVariant": k = f.variant; break; case "fontWeight": k = f.weight; break; case "fontSize": k = f.size } c = k } else $.E(c) && ("fill" == b ? k = a.we() : (k = a.Gc(), k.sourceValue = c), c = c.call(k, k)); if (d) {
                    if (e) return c * (0, window.parseFloat)(d) /
                    100; "fill" == b ? k = a.we(c) : (k = a.Gc(), k.sourceValue = c); return d.call(k, k)
                } return c
            }, ena = function (a, b) { if (b) { var c = a.f / 3, d = a.g / 3, e = a.g / 50, f = $.Va(e, ~~d + 1), h = $.Oa(f, function (a) { a = $.ig().measure(b.text, { fontStyle: b.style, fontFamily: b.font, fontSize: a, fontWeight: b.weight, fontVariant: b.variant }); var e = $.no(a, "center"); e = $.Lb($.cb(b.rotate), e.x, e.y); a = $.Ym(a) || []; e.transform(a, 0, a, 0, 4); a = $.Zm(a); e = a.width; a = a.height; return e > c || a > d ? -1 : e == c || a == d ? 0 : 1 }); 0 > h && (h = ~h - 1); a.O = e; a.Ja = f[$.Za(h, 0, f.length)] } }, fna = function (a,
            b, c, d, e) {
                if (!c.RD) {
                    var f = b.context, h = b.ratio; f.clearRect(0, 0, 2048 / h, 2048 / h); var k = b = 0, l = 0, m = d.length; --e; for (var p = a.i("textSpacing") ; ++e < m;) {
                        c = d[e]; f.save(); a = ""; "normal" != c.style && (a += c.style + " "); "normal" != c.weight && (a += c.weight + " "); "normal" != c.variant && (a += c.variant + " "); f.font = a + ~~((c.size + 1) / h) + "px " + c.font; a = f.measureText(c.text).width * h; var q = c.size << 1; if (c.rotate) {
                            var r = Math.sin($.cb(c.rotate)), t = Math.cos($.cb(c.rotate)), u = a * t, v = a * r; t *= q; a = q * r; a = Math.max(Math.abs(u + a), Math.abs(u - a)) + 31 >>
                            5 << 5; q = ~~Math.max(Math.abs(v + t), Math.abs(v - t))
                        } else a = a + 31 >> 5 << 5; q > l && (l = q); 2048 <= b + a && (b = 0, k += l, l = 0); if (2048 <= k + q) break; f.translate((b + (a >> 1)) / h, (k + (q >> 1)) / h); c.rotate && f.rotate($.cb(c.rotate)); f.fillText(c.text, 0, 0); p && (f.lineWidth = 2 * p, f.strokeText(c.text, 0, 0)); f.restore(); c.width = a; c.height = q; c.Jja = b; c.Mja = k; c.hj = a >> 1; c.Xe = q >> 1; c.gj = -c.hj; c.pe = -c.Xe; c.w0 = !0; b += a
                    } f = f.getImageData(0, 0, 2048 / h, 2048 / h).data; for (h = []; 0 <= --e;) if (c = d[e], c.w0) {
                        a = c.width; l = a >> 5; q = c.Xe - c.pe; for (m = 0; m < q * l; m++) h[m] = 0; b = c.Jja;
                        if (null == b) break; k = c.Mja; p = 0; u = -1; for (v = 0; v < q; v++) { for (m = 0; m < a; m++) r = f[2048 * (k + v) + (b + m) << 2] ? 1 << 31 - m % 32 : 0, h[l * v + (m >> 5)] |= r, p |= r; p ? u = v : (c.pe++, q--, v--, k++) } c.Xe = c.pe + u; c.RD = h.slice(0, (c.Xe - c.pe) * l)
                    }
                }
            }, gna = function (a, b) { var c = a[0], d = a[1]; b.x + b.gj < c.x && (c.x = b.x + b.gj); b.y + b.pe < c.y && (c.y = b.y + b.pe); b.x + b.hj > d.x && (d.x = b.x + b.hj); b.y + b.Xe > d.y && (d.y = b.y + b.Xe) }, hna = function (a) {
                var b = 4 * a.f / a.g, c = 0, d = 0; return function (a) {
                    var e = 0 > a ? -1 : 1; switch (Math.sqrt(1 + 4 * e * a) - e & 3) {
                        case 0: c += b; break; case 1: d += 4; break; case 2: c -=
                        b; break; default: d -= 4
                    } return [c, d]
                }
            }, ina = function (a) { for (var b = [], c = -1; ++c < a;) b[c] = 0; return b }, jna = function (a, b, c, d, e) {
                for (var f = c.x, h = c.y, k = 0, l, m; l = a.$a(k) ;) {
                    k += 1; m = ~~l[0]; l = ~~l[1]; if (Math.min(Math.abs(m), Math.abs(l)) >= e) break; c.x = f + m; c.y = h + l; if (!(m = 0 > c.x + c.gj || 0 > c.y + c.pe || c.x + c.hj > a.f || c.y + c.Xe > a.g) && (m = d)) a: {
                        m = a.f; m >>= 5; l = c.RD; var p = c.width >> 5; var q = c.x - (p << 4); for (var r = q & 127, t = 32 - r, u = c.Xe - c.pe, v = (c.y + c.pe) * m + (q >> 5), w = 0; w < u; w++) {
                            for (var x = q = 0; x <= p; x++) if ((q << t | (x < p ? (q = l[w * p + x]) >>> r : 0)) & b[v + x]) {
                                m =
                                !0; break a
                            } v += m
                        } m = !1
                    } if (!m && (!d || c.x + c.hj > d[0].x && c.x + c.gj < d[1].x && c.y + c.Xe > d[0].y && c.y + c.pe < d[1].y)) { d = c.RD; e = c.width >> 5; a = a.f >> 5; m = c.x - (e << 4); f = m & 127; h = 32 - f; k = c.Xe - c.pe; m = (c.y + c.pe) * a + (m >> 5); for (p = 0; p < k; p++) { for (r = l = 0; r <= e; r++) b[m + r] = b[m + r] | l << h | (r < e ? (l = d[p * e + r]) >>> f : 0); m += a } delete c.RD; return !0 }
                } return !1
            }, kna = function (a) {
                var b = a.aa(), c = a.hn(), d = a.oa, e = a.Jn, f = (0, window.parseFloat)(b.get("value")), h = b.get("category"), k = b.la(); if ($.K(c, $.uy) && $.n(h)) {
                    var l = h; b.o("category", h); b = a.ba.i("fill"); $.E(b) &&
                    (a = { sourceColor: a.cc().nc(k), category: h }, b = b.call(a, a)); e.push($.Vb(b))
                } else a.Lb ? l = f : (b.o("category", void 0), l = $.Vb(a8(a, "fill", 0)), e.push(l), l = $.D(l) ? l.color : l, b.o("category", l)); c.Tc(l); d.Tc(f)
            }, lna = function (a, b) { var c = new Z7(a, b); c.JD(c.ma); return c }, mna = { Cna: "spiral", A6: "rect" }; $.H(Z7, $.Rw); $.kq(Z7, "fill fontFamily fontStyle fontVariant fontWeight fontSize".split(" "), "normal"); Z7.prototype.ra = $.Rw.prototype.ra | 258064; var b8 = {};
            ...
            $.g.Eg = function (a) {
                var b = a.type; switch (b) { case "mouseout": b = "pointmouseout"; break; case "mouseover": b = "pointmouseover"; break; case "mousemove": b = "pointmousemove"; break; case "mousedown": b = "pointmousedown"; break; case "mouseup": b = "pointmouseup"; break; case "click": b = "pointclick"; break; case "dblclick": b = "pointdblclick"; break; default: return null } var c; "pointIndex" in a ? c = a.pointIndex : "labelIndex" in a ? c = a.labelIndex : "markerIndex" in a && (c = a.markerIndex); c = $.N(c); a.pointIndex = c; return {
                    type: b, actualTarget: a.target,
                    series: this, pointIndex: c, target: this, originalEvent: a, point: this.Id(c)
                }
            }; $.g.bg = function (a) { a = $.Y.prototype.bg.call(this, a); var b = $.bo(a.domTarget).index; if (!$.n(b) && $.yw(this.state, $.fo)) { var c = $.Ew(this.state, $.fo); c.length && (b = c[0]) } b = $.N(b); (0, window.isNaN)(b) || (a.pointIndex = b); return a }; $.g.am = function () { }; $.g.El = function (a) { return $.n(a) ? (a = $.qk(a), a != this.N && (this.N = a), this) : this.N }; $.g.Ji = function (a) { return $.n(a) ? (this.Wc().selectionMode(a), this) : this.Wc().i("selectionMode") };
            ...
            $.g.nb = function () {
                var a = this.oa; if (a) {
                    var b, c = this.hn(); if (this.J(8192)) { var d = this.i("anglesCount"); var e = this.i("fromAngle"); var f = this.i("toAngle"); f -= e; this.ca = []; for (b = 0; b < d; b++) this.ca.push(e + f / (1 == d ? d : d - 1) * b); this.D || this.u(16388); this.I(8192) } if (this.J(4096)) {
                        var h = this.xc(); this.U = []; this.b && this.b.forEach(function (a, b) { a.Mi.parent(null); a.Uk.parent(null); a.Uk.gl(); this.U[b] = a }, this); this.b = []; this.Jn = []; a.qg(); for (c.qg() ; h.advance() ;) {
                            b = String(h.get("x")).toLowerCase(); e = (0, window.parseFloat)(h.get("value"));
                            f = h.get("category"); var k = h.la(); var l = this.U[k] ? this.U[k] : {}; l.rowIndex = k; l.text = b; l.value = e; l.fC = !1; l.koa = f; this.b.push(l); h.o("item", l); kna(this)
                        } a.zg(); c.zg(); this.Lb || ($.Ka(this.Jn, void 0, function (a) { return $.D(a) ? a.color + " " + a.opacity : a }), dna(c, this.Jn)); $.Ra(this.b, function (a, b) { return b.value - a.value }); this.u(16388); this.I(200704)
                    } if (this.J(196608)) {
                        this.Jn = []; h = this.xc(); a.qg(); for (c.qg() ; h.advance() ;) kna(this); c.zg(); this.Lb || ($.Ka(this.Jn, void 0, function (a) {
                            return $.D(a) ? a.color + " " + a.opacity :
                            a
                        }), dna(c, this.Jn)); this.J(65536) && this.u(49680); this.J(131072) && this.u(49156); this.I(196608)
                    } if (this.J(16384)) {
                        var m = this.D ? this.D : this.ca; var p = Math.max((0, $.za)(m, 0), 0); d = m.length; a = this.b.length ? this.b[0].value : window.NaN; h = this.aa(); c = this.b.length; var q = 0; this.b.forEach(function (a, b) {
                            var c = $.Tl($.zw(this.state, a.rowIndex)); h.select(a.rowIndex); var e = a8(this, "fontFamily", c), f = a8(this, "fontStyle", c), k = a8(this, "fontVariant", c), l = a8(this, "fontWeight", c); c = $.Vb(a8(this, "fill", c)); a.font = e; a.style =
                            f; a.variant = k; a.weight = l; a.fill = c; a.rotate = m[(b + p + d) % d]; q += a.value
                        }, this); this.Ia("sum", q); this.Ia("max", a); this.Ia("min", this.b.length ? this.b[c - 1].value : window.NaN); this.Ia("average", q / c); this.Ia("pointsCount", c); this.I(16384)
                    }
                }
            }; $.g.Ju = function () { this.nb() };
            $.g.Ui = function (a) {
                var b = this.scale(), c = $.Yq(this, "colorRange"); this.J(32768) && c && ($.V(c), c.scale(this.hn()), c.target(this), c.ob(this), c.da(!1), c.enabled() && this.u(4)); if (this.J(4)) {
                    c && c.enabled() ? (c.ja(a.clone().round()), this.j = c.rd()) : this.j = a.clone(); this.f = this.j.width; this.g = this.j.height; this.$a = "spiral" == this.i("mode") ? this.Iaa : hna(this); a = this.b.length; var d = this.b[0], e = -1, f = null, h = this.getContext(this.canvas ? this.canvas : this.canvas = window.document.createElement("canvas")), k = ina((this.f >>
                    ...
                    d.x -= this.f >> 1, d.y -= this.g >> 1); a = f ? Math.min(this.f / Math.abs(f[1].x - this.f / 2), this.f / Math.abs(f[0].x - this.f / 2), this.g / Math.abs(f[1].y - this.g / 2), this.g / Math.abs(f[0].y - this.g / 2)) / 2 : 1; this.ub || (this.ub = this.Ma.Md()); (e = $.Yq(this, "background")) && this.ub.zIndex((e.zIndex() || 0) + 1); this.G || (this.G = this.ub.Md(), $.Et(this, this.G)); this.oe || (this.oe = this.ub.Md()); this.ka = this.j.left + (this.f >> 1); this.ta = this.j.top + (this.g >> 1); this.Ga = a; this.ub.ic(a, 0, 0, a, this.ka, this.ta); var m = this.ub.Dd; this.b.forEach(function (a) {
                        ...
                        [a.x, a.y]; m.transform(b, 0, b, 0, 1); if (b[0] + a.gj < this.j.left || b[0] + a.hj > this.j.Za() || b[1] + a.pe < this.j.top || b[1] + a.Xe > this.j.Ta()) a.fC && (a.Mi.parent(null), a.Uk.parent(null)), a.fC = !1; else {
                            ...
                            a.Uk.be("font-style", e); a.Uk.be("font-variant", f); a.Uk.be("font-weight", h); a.Uk.be("font-size", c); a.Uk.be("transform", "translate(" + [a.x, a.y] + ")rotate(" + a.rotate + ")"); a.Uk.zIndex(0)
                        }
                    }, this); this.I(16); this.I(4)
                } this.J(32768) && (c && ($.V(c), c.P(this.Ma), c.Y(), c.da(!1)), this.I(32768)); if (this.J(16)) { var p = this.xc(); this.b.forEach(function (a) { var b = $.Tl($.zw(this.state, a.rowIndex)); p.select(a.rowIndex); a.fC && a.Mi && $7(a.Mi, $.Vb(a8(this, "fill", b))) }, this); this.I(16) }
            }; $.g.rC = function () { return ["x"] };
            ...
            c8.hovered = c8.kb; c8.selected = c8.selected; c8.hover = c8.Bi; c8.unhover = c8.Jd; c8.select = c8.Ii; c8.unselect = c8.Yd; c8.getPoint = c8.Id; $.zp["tag-cloud"] = lna; $.F("anychart.tagCloud", lna);
        }).call(this, $)
    }
    if (!_.theme_tag_cloud) {
        _.theme_tag_cloud = 1; (function ($) {
            $.ra($.fa.anychart.themes.defaultTheme, {
                tagCloud: {
                    anglesCount: 7, fromAngle: -90, toAngle: 90, mode: "spiral", textSpacing: 1, scale: { type: "linear" }, colorRange: {}, colorScale: null, normal: { fontFamily: "Verdana, Helvetica, Arial, sans-serif", fontOpacity: 1, fontDecoration: "none", fontStyle: "normal", fontVariant: "normal", fontWeight: "normal", fill: function () { return $.Il(this.scaledColor || this.sourceColor, .85, !0) } }, hovered: { fill: $.dM }, selected: { fill: "#333 0.85" }, tooltip: {
                        enabled: !0, title: { enabled: !0 }, separator: { enabled: !0 },
                    ...
                    }, legend: { enabled: !1, itemsSourceMode: "categories", tooltip: { contentInternal: { background: { disablePointerEvents: !1 } } } }
                }
            });
        }).call(this, $)
    }
