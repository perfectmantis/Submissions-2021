...
def welcom():
    ...
    if hour >= 4 and hour<12:
        ...
        print("Good morning "+titl+id+", i am your virtual assistant. How May I Help you?")
    elif hour>=12 and hour<17:
        tts.speak("Good afternoon "+titl+id+", i am your virtual assistant. How May I Help you?")
        print("Good afternoon "+titl+id+", i am your virtual assistant. How May I Help you?")
    elif hour>=17 and hour<21:
        tts.speak("Good evening "+titl+id+", i am your virtual assistant. How May I Help you?")
        print("Good evening "+titl+id+", i am your virtual assistant. How May I Help you?")
    else:
        tts.speak("hi "+titl+id+", i am your virtual assistant. How May I Help you?")
        print("Hi "+titl+id+", i am your virtual assistant. How May I Help you?")
