...
def add_face():
    ...
    if id == "" or id == "Unknown":
        ...
        tts.speak("Do I identifying you correctly? Type 'y' for Yes, 'n' for No, or anything else to abort.")
        conf = input("Do I identifying you correctly? Type 'y' for Yes, 'n' for No, or anything else to abort: ").lower()
        if conf == "y":
            pass
        elif conf == "n":
            nmSlist()
            while True:
                ...
                nam = input("Find your name from the list and type here or Type 'cancel' to abort: ").lower()
                if nam == "cancel":
                    return
                if nam in nmS:
                    break
