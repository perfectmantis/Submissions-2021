...
mysqli_select_db($database_job, $job);
$query_Recordset1 = "SELECT MinQualification FROM job_master";
$Recordset1 = mysqli_query($query_Recordset1, $job) or die(mysqli_error());
...
$Recordset3 = mysqli_query($query_Recordset3, $job) or die(mysqli_error());
$row_Recordset3 = mysqli_fetch_assoc($Recordset3);
$totalRows_Recordset3 = mysqli_num_rows($Recordset3);

mysqli_select_db($database_job, $job);
$query_Recordset4 = "SELECT distinct CompanyName FROM job_master";
$Recordset4 = mysqli_query($query_Recordset4, $job) or die(mysqli_error());
$row_Recordset4 = mysqli_fetch_assoc($Recordset4);
$totalRows_Recordset4 = mysqli_num_rows($Recordset4);

mysqli_select_db($database_job, $job);
$query_Recordset5 = "SELECT distinct JobTitle FROM job_master";
$Recordset5 = mysqli_query($query_Recordset5, $job) or die(mysqli_error());
...
$Recordset2 = mysqli_query($query_Recordset2, $job) or die(mysqli_error());
